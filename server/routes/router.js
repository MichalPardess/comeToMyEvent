...
route.get('/guest-list-isen',services.guest_list_B);
route.get('/guest-list-atzur',services.guest_list_C);
route.get('/guest-list-pepper',services.guest_list_D);
...
route.get('/yehudit-yair',services.rsvp_B);
route.get('/uriel-shira',services.rsvp_C);
route.get('/shuki-shira-wedding',services.rsvp_C2);
route.get('/shira-uriel',services.rsvp_D);
